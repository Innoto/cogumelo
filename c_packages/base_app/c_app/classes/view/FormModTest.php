  ...
  */
  ...
  function loadForm() {
    ...
    */
    ...
    '  <script src="/vendor/jquery-validation/dist/jquery.validate.js" type="text/javascript"></script>'."\n".
    '  <script src="/vendor/jquery-validation/dist/additional-methods.js" type="text/javascript"></script>'."\n".
    '  <script src="/media/module/form/js/jquery.cogumeloFormController.js" type="text/javascript"></script>'."\n".
    '  <script src="/media/module/form/js/jquery.serializeFormToObject.js" type="text/javascript"></script>'."\n".
    '  <script src="/media/module/form/js/formValidators.js" type="text/javascript"></script>'."\n".
    '  <script src="/media/module/form/js/formValidatorsExtender.js" type="text/javascript"></script>'."\n".
    /*
  ...
  function ajaxUpload() {
    error_log( '--------------------------------' );error_log( '--------------------------------' );
    error_log( 'ajaxUpload FormModTest');
    error_log( '--------------------------------' );error_log( '--------------------------------' );
    ...
    if( isset( $_FILES['ajaxFileUpload'] ) ) {
      ...
      if( !$error ) {
        if( isset( $_POST[ 'cgIntFrmId' ] ) ) {
          ...
          // Creamos un objeto recuperandolo de session y añadiendo los datos POST
          $form = new FormController( false, false, $cgIntFrmId, false );
          // Creamos un objeto con los validadores y lo asociamos
          $form->setValidationObj( new FormValidators() );
