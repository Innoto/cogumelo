...
class C_i18n {
	...
	static function c_i18n_gettext(){
		if($_SERVER["REMOTE_ADDR"] == "127.0.0.1")
		{
			...
			//exec('find '.COGUMELO_LOCATION.'/. ../c_app/. -iname "*.php" -o -iname "*.php" | xargs xgettext -kT_gettext -kT_ --from-code utf-8 -d c_project -o ../c_app/i18n/c_project.pot -L PHP');
			foreach(explode(',', 'gl,es,en') as $lng) {
				shell_exec('xgettext --from-code=UTF-8 -o /home/proxectos/cogumelo/c_packages/base_app/httpdocs/../c_app/conf/i18n/en/LC_MESSAGES/messages_'.$lng.'.po /home/proxectos/cogumelo/c_packages/base_app/httpdocs/../c_app/../*.php');
			}
